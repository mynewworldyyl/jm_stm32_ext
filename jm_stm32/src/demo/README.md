...
└── jm_stm32_oled_test.c         # OLED 显示屏测试源文件
```
...
| [OLED 显示屏测试](README_OLED.md) | `jm_stm32_oled_test.c` | OLED 初始化与文字显示 | `JM_STM32_TESTOLED_ENABLE` |
...
#define JM_STM32_TESTOLED_ENABLE 1  // 启用 OLED 测试
#define JM_OLED_ENABLE 1            // 启用 OLED 模块
```
...
| [OLED 显示屏测试](README_OLED.md) | OLED 初始化与文字显示 |
